...
public class Owca extends Zwierze {
    ...
    public Owca(int sila, int inicjatywa, int x, int y, SwiatInterface swiat, String znak) {
    ...
    public void akcja() {
        ...
        int oldY = getY();
        super.akcja();
        String log = "Owca przesunela sie z miejsca (" + oldX + "," + oldY + ") na miejsce (" + getX() + "," + getY() + ")";
    ...
    {
        return new Owca(4, 4, x, y, swiat, znak);
    }
